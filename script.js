...
function endOther(str1, str2){
    ...
    if(str1[str1.length-3] == str2[str2.length-3] && str1[str1.length-2] == str2[str2.length-2] && str1[str1.length-1] == str2[str2.length-1]){
        num = true;
    }
    if(str1[str1.length-2] == str2[str2.length-2] && str1[str1.length-1] == str2[str2.length-1]){
        num = true;
    }
...
function getSandwich(str){
    ...
    if(bread1 != bread2){
        sandwich += str.substring(bread1 + 5, bread2);
    }
    return sandwich;
}
